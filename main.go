...
func main() {
	...
	playHistoryBridge := backend.NewPlayHistoryBridge(apiClient)
	systemBridge := backend.NewSystemBridge()
	audioBridge := backend.NewAudioBridge()
	searchBridge := backend.NewSearchBridge(apiClient)
